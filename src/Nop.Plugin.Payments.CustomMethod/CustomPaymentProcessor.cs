...
public class CustomPaymentProcessor : BasePlugin, IPaymentMethod
{
    private readonly CustomPaymentSettings _settings;
    private readonly ISettingService _settingService;
    private readonly IWebHelper _webHelper;
    public CustomPaymentProcessor(CustomPaymentSettings settings,
    ...
    {
        return $"{_webHelper.GetStoreLocation()}Admin/PaymentCustom/Configure";
    }
